...
merge_KC_clusters <- function(keys_vect, vect, dict, keys_dict) {
    .Call('_refinr_merge_KC_clusters', PACKAGE = 'refinr', keys_vect, vect, dict, keys_dict)
}

merge_KC_clusters_no_dict <- function(clusters, keys_vect, vect) {
    .Call('_refinr_merge_KC_clusters_no_dict', PACKAGE = 'refinr', clusters, keys_vect, vect)
}

merge_KC_clusters_dict <- function(clusters, keys_vect, vect, keys_dict, dict) {
    .Call('_refinr_merge_KC_clusters_dict', PACKAGE = 'refinr', clusters, keys_vect, vect, keys_dict, dict)
}
